...
export default function Dashboard() {
  ...
  const userData = JSON.parse(localStorage.getItem('user')) || { username: 'Người dùng', credits: 0 };

  return <div className="page-wrap">
    <PageHeader 
      eyebrow="TRUNG TÂM ĐIỀU KHIỂN" 
      title={`Chào buổi sáng, ${userData.username} 👋`} 
      description="Theo dõi hoạt động, credit và tiến trình tạo video của bạn." 
      action={<Link className="btn btn-primary" to="/create"><Icon name="plus" className="w-4 h-4"/>Tạo video mới</Link>} 
    />

    <div className="stats-grid">
      <StatCard label="Credit khả dụng" value={userData.credits} sub="12 credit miễn phí hôm nay" icon="sparkles" tone="indigo" />
